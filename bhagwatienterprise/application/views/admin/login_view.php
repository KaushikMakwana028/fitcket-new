...
<head>
	...
	<title>bhagwatienterprise</title>
...
<body class="">
							...
							<div class="card-body">
								...
								<div class="p-4">
									...
									<div class="text-center mb-4">
										...
										<h5 class="">Bhagwati Enterprise</h5>
    ...
    <input type="tel" name="mobile" class="form-control" id="inputMobile" placeholder="Enter your mobile number" pattern="[0-9]{10}" maxlength="10">
