 ...
 public function register_user()
{
    ...
    if (empty($input_data)) {
        return $this->output->set_status_header(400)->set_output(json_encode([
            'status'=>false,'code'=>400,'message'=>'Invalid request payload.','data'=>null
        ]));
    }
    ...
    if (!$first_name || !$last_name || !$email || !$mobile) {
        return $this->output->set_status_header(400)->set_output(json_encode([
            'status'=>false,'code'=>400,'message'=>'All fields are required.','data'=>null
        ]));
    }

    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        return $this->output->set_status_header(400)->set_output(json_encode([
            'status'=>false,'code'=>400,'message'=>'Invalid email address.','data'=>null
        ]));
    }
    ...
    if ($exists) {
        return $this->output->set_status_header(400)->set_output(json_encode([
            'status'=>false,'code'=>400,'message'=>'This mobile number is already registered.','data'=>null
        ]));
    }
...
public function register_verify_otp()
{
    ...
    if (!$mobile || !$entered_otp) {
        return $this->output->set_status_header(400)->set_output(json_encode([
            'status'=>false,'code'=>400,'message'=>'Mobile & OTP required.','data'=>null
        ]));
    }
    ...
    if (!$otp_row) {
        return $this->output->set_status_header(400)->set_output(json_encode([
            'status'=>false,'code'=>400,'message'=>'Invalid or expired OTP.','data'=>null
        ]));
    }
