    ...
    <div class="login-wrapper">
        ...
        <div class="login-right">
            ...
            <div class="mobile-badge">
                📱 <?= htmlspecialchars($masked_mobile) ?>
            </div>
            ...
            <div class="otp-inputs" id="otp">
                <input class="otp-box" type="text" inputmode="numeric" maxlength="1" id="d1" autocomplete="one-time-code">
                ...
                <input class="otp-box" type="text" inputmode="numeric" maxlength="1" id="d6">
            </div>
            ...
            <button class="btn-validate" id="validateBtn">
                ...
                <span id="btnText"><i class="bx bx-check-shield"></i> Verify OTP</span>
            </button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            validateBtn.addEventListener('click', function() {
                ...
                $.ajax({
                    url: "<?= base_url('provider/login/verify_otp') ?>",
                    type: "POST",
                    data: {
                        otp: otp
                    },
            ...
            resendBtn.addEventListener('click', function() {
                ...
                $.ajax({
                    url: "<?= base_url('provider/login/resend_otp') ?>",
                    type: "POST",
                    success: function() {
                        hideError();
                    },
