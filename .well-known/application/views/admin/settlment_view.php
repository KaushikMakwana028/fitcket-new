            ...
            <div class="card-body">
                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="position-relative">
                        <input id="searchInput" type="text" class="form-control ps-5 radius-30" placeholder="Search by User">
                    ...
                    <div class="filter-bar ms-auto">
                        <div class="btn-group" role="group">
                            ...
                            <button class="btn btn-sm btn-outline-success filter-btn" data-filter="success">Success</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table mb-0" id="SettlementTable">
