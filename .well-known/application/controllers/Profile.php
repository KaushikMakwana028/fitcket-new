...
public function index($offset = 0)
{
    ...
    ====================================================== */
    $this->db->select('provider.id');  // ✅ Select primary key
    ...
    $this->db->group_by('provider.id');  // ✅ Group by primary key
    ...
    ====================================================== */
    // ✅ FIXED: Explicitly list all columns OR use GROUP BY with primary key
    $this->db->select("
        provider.id,
    ...
    // ✅ FIXED: Group by primary key (provider.id)
